...
class DATImage:
    """Import Elmitec dat format file containing image and metadata.
    Return an instance of DATImage class.
    ...
    def __init__(self, filename, verbose=False, *args, **key_args):
